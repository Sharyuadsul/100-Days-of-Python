...
#Firstly register to Pixela with your Username

USER ="sharyuadsul19"  #Replace with your Username
TOKEN = os.getenv("PIXELA_TOKEN")  #randomly chosen unique
...
#check the graph on  https://pixe.la/v1/users/<username>/graphs/<graphid>.html